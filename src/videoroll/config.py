...
class RenderWorkerSettings(BaseSettings):
    ...
    max_concurrency: int = Field(32, ge=1, le=32, alias="RENDER_WORKER_MAX_CONCURRENCY")
    device_max_concurrency: int = Field(1, ge=1, le=8, alias="RENDER_WORKER_DEVICE_MAX_CONCURRENCY")
