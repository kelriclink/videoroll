...
class SubtitleServiceSettings(CommonSettings):
    ...
    external_whisper_batch_size: int = Field(1, ge=1, le=32, alias="SUBTITLE_EXTERNAL_WHISPER_BATCH_SIZE")
    external_whisper_vad_enabled: bool = Field(True, alias="SUBTITLE_EXTERNAL_WHISPER_VAD_ENABLED")
    external_whisper_vad_threshold: float = Field(0.5, ge=0.1, le=0.95, alias="SUBTITLE_EXTERNAL_WHISPER_VAD_THRESHOLD")
    external_whisper_min_silence_ms: int = Field(2000, ge=50, le=5000, alias="SUBTITLE_EXTERNAL_WHISPER_MIN_SILENCE_MS")
    external_whisper_speech_pad_ms: int = Field(400, ge=0, le=2000, alias="SUBTITLE_EXTERNAL_WHISPER_SPEECH_PAD_MS")
    external_whisper_condition_on_previous_text: bool = Field(True, alias="SUBTITLE_EXTERNAL_WHISPER_CONDITION_ON_PREVIOUS_TEXT")
    external_whisper_max_segment_seconds: float = Field(12.0, ge=1.0, le=30.0, alias="SUBTITLE_EXTERNAL_WHISPER_MAX_SEGMENT_SECONDS")
    external_whisper_max_segment_chars: int = Field(120, ge=10, le=500, alias="SUBTITLE_EXTERNAL_WHISPER_MAX_SEGMENT_CHARS")
...
class RenderWorkerSettings(BaseSettings):
    ...
    heartbeat_interval_seconds: float = Field(15.0, ge=5.0, le=60.0, alias="RENDER_WORKER_HEARTBEAT_INTERVAL_SECONDS")
