...
class SubtitleServiceSettings(CommonSettings):
    ...
    external_whisper_min_silence_ms: int = Field(500, ge=50, le=5000, alias="SUBTITLE_EXTERNAL_WHISPER_MIN_SILENCE_MS")
    external_whisper_speech_pad_ms: int = Field(180, ge=0, le=2000, alias="SUBTITLE_EXTERNAL_WHISPER_SPEECH_PAD_MS")
    external_whisper_condition_on_previous_text: bool = Field(False, alias="SUBTITLE_EXTERNAL_WHISPER_CONDITION_ON_PREVIOUS_TEXT")
    external_whisper_max_segment_seconds: float = Field(6.0, ge=1.0, le=30.0, alias="SUBTITLE_EXTERNAL_WHISPER_MAX_SEGMENT_SECONDS")
    external_whisper_max_segment_chars: int = Field(80, ge=10, le=500, alias="SUBTITLE_EXTERNAL_WHISPER_MAX_SEGMENT_CHARS")
